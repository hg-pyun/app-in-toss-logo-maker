...
import { AppTabs, type AppTabValue } from '@/components/layout/AppTabs';
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<AppTabValue>('prompt');
        ...
        <AppTabs value={activeTab} onValueChange={setActiveTab}>
          <main>
            <TabsContent value="prompt" className="mt-0">
              <div className="mx-auto grid w-full max-w-6xl gap-6 px-4 py-6 md:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] md:gap-8 md:px-6 md:py-10">
            ...
            <TabsContent value="postprocess" className="mt-0">
